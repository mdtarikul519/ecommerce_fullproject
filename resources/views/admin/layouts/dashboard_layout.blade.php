                ...
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="index.html" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="{{ asset('contents/admin/assets') }}/images/logo.svg" alt=""
                                    height="22">
                            </span>
                            <span class="logo-lg">
                        ...
                        <a href="index.html" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="{{ asset('contents/admin/assets') }}/images/logo-light.svg" alt=""
                                    height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="{{ asset('contents/admin/assets') }}/images/logo-light.png" alt=""
                                    height="19">
                            </span>
                        </a>
                    </div>
                    ...
                    <div class="dropdown d-inline-block">
                        <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                            ...
                            <img class="rounded-circle header-profile-user"
                                src="{{ asset('contents/admin/assets') }}/images/users/avatar-1.jpg"
                                alt="Header Avatar">
